...
CREATE TABLE `t_area` (
  ...
  `area_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '区域名称',
...
CREATE TABLE `t_dishes` (
  ...
  `dishes_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '菜品名称',
  `dishes_img` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '菜品图片',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
...
CREATE TABLE `t_dishes_class` (
  ...
  `gerent_id` int(11) NOT NULL COMMENT '商家(后台)账号ID',
  `shop_id` int(11) NOT NULL COMMENT '商家(后台)店铺ID',
  `dishes_class_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '菜品类型名称',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `creator` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建者名称',
  `creator_id` int(11) NOT NULL COMMENT '创建者ID',
...
CREATE TABLE `t_gerent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'NON' COMMENT '名称',
  `nick` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '昵称',
  `avatar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '/defaultHead.jpg' COMMENT '头像',
...
CREATE TABLE `t_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menu_name` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '菜单名',
...
CREATE TABLE `t_order` (
  ...
  `gerent_id` int(11) NOT NULL COMMENT '商家(后台)账号ID',
  `shop_id` int(11) NOT NULL COMMENT '商家(后台)店铺ID',
  `order_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'NON' COMMENT '订单号',
  `price` int(10) DEFAULT '0' COMMENT '价格(分)',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '(下单)创建时间',
  `process_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '状态时间',
  `book` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '下单者名称',
  `book_id` int(11) NOT NULL COMMENT '下单者ID',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '使用状态 0-待取餐 1-已取消 2-已完成',
  `area_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '区域',
  `table_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '桌号',
...
CREATE TABLE `t_order_detail` (
  ...
  `price` int(10) DEFAULT '0' COMMENT '价格(分)',
  `dishes_type_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '未知' COMMENT '菜品类型名称',
  `dishes_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '菜品名称',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '(下单)创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_name` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '角色名',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `creator` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建者名称',
  `creator_id` int(11) NOT NULL COMMENT '创建者ID',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gerent_id` int(11) NOT NULL COMMENT '商家(后台)账号ID',
  `shop_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '店铺名称',
...
CREATE TABLE `t_table` (
  ...
  `table_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'NON' COMMENT '餐桌名称(桌号)',
  `creator_id` int(11) NOT NULL COMMENT '创建者ID',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_table_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shop_id` int(11) NOT NULL COMMENT '商家(后台)店铺ID',
  `table_type_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '餐桌类型名称',
  `creator_id` int(11) NOT NULL COMMENT '创建者ID',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '无名' COMMENT '名称',
  `avatar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '头像',
  `password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'E10ADC3949BA59ABBE56E057F20F883E' COMMENT '密码',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态 0-注销 1-正常',
  `openid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户的唯一标识',
  `nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户昵称',
  `sex` tinyint(1) NOT NULL COMMENT '微信授权信息 用户的性别，值为1时是男性，值为2时是女性，值为0时是未知',
  `province` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户填写的省份',
  `city` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户填写的城市',
  `country` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 国家',
  `headimgurl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户头像',
  `privilege` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '微信授权信息 用户特权信息，json 数组，如微信沃卡用户为（chinaunicom）',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_weixin_business` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gerent_id` int(11) NOT NULL COMMENT '商家(后台)账号ID',
  `app_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '微信appid',
  `app_secret` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '微信密钥',
  `creation_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
